            ...
            <div class="tab-content" id="myTabContent">
              ...
              >
                ...
                <h3 class="white text-center">
                  ...
                  supposed inform the vaccine maker if you tested positive, by
                  clicking a "Report Positive" button in the dashboard.
                </h3>
              </div>
            </div>
          </div>
        ...
        <div v-else class="card">
          <div class="card-body">
            ...
            <p v-if="!testedPositive" class="card-text white text-center mt-3">
              ...
              <br />
              Your Vaccine details was recieved. In a few weeks, you will be
              asked to take a test to see if you are infected. Your are suposted
            ...
            <p v-else class="white text-center">
              ...
              recieved. We will notify you upon the final vaccine test results.
            </p>
